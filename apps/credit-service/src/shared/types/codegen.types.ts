...
export type ResolversTypes = {
  ...
  CreditAccount: ResolverTypeWrapper<
    ResolversInterfaceTypes<ResolversTypes>["CreditAccount"]
  >;
  CreditAccountDetailsInput: CreditAccountDetailsInput;
  CreditAccountResult: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>["CreditAccountResult"]
  >;
...
export type CreditAccountResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["CreditAccount"] = ResolversParentTypes["CreditAccount"],
> = {
...
export type CreditAccountResultResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["CreditAccountResult"] = ResolversParentTypes["CreditAccountResult"],
> = {
  __resolveType: TypeResolveFn<
    "GiftAccount" | "PrepaidAccount",
    ParentType,
...
export type GiftAccountResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["GiftAccount"] = ResolversParentTypes["GiftAccount"],
> = {
  availableCredits?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  availableMoney?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
...
> = {
  cancelCreditAccountFlow?: Resolver<
  ...
  createGiftAccount?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateGiftAccountArgs, "input">
  >;
  createPrepaidAccount?: Resolver<
    ResolversTypes["CreditAccount"],
    ParentType,
    ContextType,
    RequireFields<MutationCreatePrepaidAccountArgs, "input">
  >;
  finalizeCreditAccount?: Resolver<
    ResolversTypes["CreditAccount"],
    ParentType,
    ContextType
  >;
  nullifyAccount?: Resolver<
    ResolversTypes["CreditAccount"],
    ParentType,
    ContextType,
    Partial<MutationNullifyAccountArgs>
  >;
  refundCredits?: Resolver<
    ResolversTypes["CreditAccount"],
    ParentType,
    ContextType,
    RequireFields<MutationRefundCreditsArgs, "input">
  >;
  refundMoney?: Resolver<
    ResolversTypes["CreditAccount"],
    ParentType,
    ContextType,
    RequireFields<MutationRefundMoneyArgs, "input">
  >;
  selectCreditAccountType?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationSelectCreditAccountTypeArgs, "type">
  >;
  setCreditAccountEmail?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationSetCreditAccountEmailArgs, "email">
  >;
  submitCreditAccountDetails?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationSubmitCreditAccountDetailsArgs, "details">
  >;
  transferCredits?: Resolver<
    ResolversTypes["Transfer"],
    ParentType,
    ContextType,
    RequireFields<MutationTransferCreditsArgs, "input">
  >;
  useCredits?: Resolver<
    ResolversTypes["CreditAccount"],
    ParentType,
    ContextType,
    RequireFields<MutationUseCreditsArgs, "input">
  >;
  validateCreditAccount?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
...
export type PrepaidAccountResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["PrepaidAccount"] = ResolversParentTypes["PrepaidAccount"],
> = {
  availableCredits?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  availableMoney?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
...
> = {
  allCreditAccounts?: Resolver<
    Array<ResolversTypes["CreditAccount"]>,
    ParentType,
    ContextType
  >;
  creditAccountByCode?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryCreditAccountByCodeArgs, "code">
  >;
  creditAccountByEmail?: Resolver<
    Maybe<Array<ResolversTypes["CreditAccount"]>>,
    ParentType,
    ContextType,
