...
import type { GiftAccount, PrepaidAccount, Transaction } from "apps/api/src/shared/types/codegen.types";

export function mapToGraphQL(dto: CreditAccountDTO): GiftAccount | PrepaidAccount {
  const shared = {
