...
import {
	CreditAccount,
	GiftAccount,
} from "../../../../credit-service/src/modules/creditaccount/domain/CreditAccount";
import { Money } from "../../../../credit-service/src/modules/creditaccount/domain/valueobjects/Money";
import { PaymentDetails } from "../../../../payment-service/src/modules/paymentDetails/domain/PaymentDetails";
import { createNewCreditAccount } from "../../../../credit-service/src/modules/creditaccount/domain/CreditAccountFactory";
