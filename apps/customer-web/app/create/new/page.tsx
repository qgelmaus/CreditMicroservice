...
import { PageHeader, Grid } from "@hovedopgave2025/ui";
  ...
  const handlePayment = async () => {
    try {
      const result = await createAndComplete({
        ...
        type: selectedType,
        treatmentCount:
          selectedType === "PREPAID_CARD" ? treatmentCount : undefined,
        pricePerTreatment:
          selectedType === "PREPAID_CARD" ? pricePerTreatment : undefined,
      ...
      <Grid maxWidth="350px" columns={1}>
        ...
        {flowState === FlowState.ChooseType && (
          <ChooseTypeStep
            ...
            onContinue={() => setFlowState(FlowState.EnterEmail)}
          />
        )}
        ...
        {flowState === FlowState.EnterEmail && (
          <EmailStep
            ...
            onContinue={() => {
              if (selectedType === "GIFT_CARD")
                setFlowState(FlowState.EnterGiftDetails);
        ...
        {flowState === FlowState.EnterPrepaidDetails && (
          <PrepaidDetailsStep
            ...
            setTreatmentCount={setTreatmentCount}
            pricePerTreatment={pricePerTreatment}
            setPricePerTreatment={setPricePerTreatment}
            onContinue={() => {
              calculateCost();
              setFlowState(FlowState.Summary);
            }}
